        ...
        <main id="js-page-content" role="main" class="page-content">
            <div class="col-md-6">
                <div id="panel-1" class="panel">
                    ...
                    // 1. Создал БД со всеми пчп проектами, где они пресутсвуют. Например, <?php echo["Название "];здесь нет ничего и после вопросительного знака точка запетой не должно быть;?;>
                    // 2. Потом выбирал из базы проект
                    // 3. И действие пошли
